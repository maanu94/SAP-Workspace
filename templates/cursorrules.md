...
- **ABAP Environment**: Steampunk, RAP (RESTful ABAP Programming), CDS Views
...
- **"Modo documentación"** → Generate formal SAP documentation (ADR, FS, TS)
...
- `/sap-export` — Export ADR/FS/TS/MAP/TEST to Word (DOCX) format
